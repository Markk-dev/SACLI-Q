        ...
        <div class="bg-gray-50 min-h-screen flex items-center justify-center px-6 lg:px-0">
            <div class="p-12 border border-gray-200 rounded-xl bg-white shadow-lg w-full lg:w-1/2">
                ...
                <div class="flex justify-center mt-8">
                    <a href="{{ route('ticketing', ['id' => $queued->queue_id]) }}" class="px-8 py-4 bg-indigo-600 text-white text-lg font-bold rounded-lg shadow hover:bg-indigo-700 transition-all">
                        Back to Ticketing
                    </a>
                </div>
            </div>
